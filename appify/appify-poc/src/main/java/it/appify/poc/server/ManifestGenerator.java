...
public class ManifestGenerator extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		printCommentedProperties("no-cache-resource/manifest.properties", "version", resp.getWriter());
		...
		String moduleName = readPropertyFrom("no-cache-resource/manifest.properties", "gwtModuleName");
		readFile(moduleName + "-artifacts.lst", resp.getWriter());

		listFiles("to-cache-resource/", resp.getWriter());
		...
		resp.getWriter().println("no-cache-resource/online.json to-cache-resource/offline.json");
		resp.getWriter().println("");
